#ifndef PISOUND_MICRO_MIDI_CONTROL_SERVER_LOADER_H
#define PISOUND_MICRO_MIDI_CONTROL_SERVER_LOADER_H

#include "config-loader.h"

class MidiControlServerLoader : public IControlServerLoader
{
public:
...
#endif // PISOUND_MICRO_MIDI_CONTROL_SERVER_LOADER_H
